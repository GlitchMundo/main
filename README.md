...
É uma rede de desenvolvedores de jogos do Brasil todo, organizados em grupos menores, que se unem para fazer coisas que acham importantes para todos os desenvolvedores. O GlitchMundo 1.0 é o primeiro evento organizado por essa rede!
...
![Programação]({{ "/assets/SP_Glitch_Programacao_baixa.png" | absolute_url }})
...
- Voyageur — Bruno Dias
## Jogaí!
Momento aberto para expor jogos e jogar jogos. Todos são convidados para trazer o projetinho secreto no qual estão trabalhando, fazer playtest e dar feedback para os demais desenvolvedores!
Desenvolvedores de jogos e público em geral estão convidados, lanchinhos patrocinados pela Unity.
